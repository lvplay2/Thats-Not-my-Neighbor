...
func yog() -> void:
	id_photo = load("res://Assets/Graphics/Char_Yog_Small_Photo.png")
	entry_photo = load("res://Assets/Graphics/Char_Yog_Long_Photo.png")
	name_char = "Yog"
	last_name_char = "Sothoth"
	number_id = "689547464823"
	id_exp_date = "04/1973"
	if Global.language == SPANISH_VALUE:
		apart_number = "P02-04"
		if randi_range(0,1) == 0:
			entry_request_reason = "Soy residente de este círculo astral, salí a consumir sangre."
		else:
		...
		if randi_range(0,1) == 0:
			not_today_list_text = ["No estoy en la lista porque tuve que hacer un vampirismo de emergencia."]
		else:
		...
		apart_number = "F02-04"
		if randi_range(0,1) == 0:
			entry_request_reason = "I am a resident of this astral circle, I went out to consume blood."
		else:
		...
		if randi_range(0,1) == 0:
			not_today_list_text = ["I'm not on the list because I had to perform emergency vampirism."]
		else:
		...
		apart_number = "F02-04"
		if randi_range(0,1) == 0:
			entry_request_reason = "我是这个星体圈的居民，我出去消耗血液。"
		else:
		...
		if randi_range(0,1) == 0:
			not_today_list_text = ["我不在名单上，因为我不得不进行紧急的吸血鬼活动。"]
		else:
		...
		0: #Name/Lastname
			...
			match random:
				0:
					name_char = "Yoj"
				1:
					last_name_char = "Sotohth"
				2:
					last_name_char = "Sohtoth"
				_:
					last_name_char = "Sotthoth"
		1: #ID
			random = randi_range(0,3)
			match random:
				0:
					number_id = "689546474823"
				1:
					number_id = "689544764823"
				2:
					number_id = "689544746823"
				_:
					number_id = "689647464823"
		2: # Nose
			...
			match random:
				0:
					...
					id_photo = load("res://Assets/Graphics/Char_Yog_Small_Photo_doppel_05.png")
					entry_photo = load("res://Assets/Graphics/Char_Yog_Long_Photo_doppel_05.png")
				_:
					nose_doppel_02.visible = true
					id_photo = load("res://Assets/Graphics/Char_Yog_Small_Photo_doppel_04.png")
					entry_photo = load("res://Assets/Graphics/Char_Yog_Long_Photo_doppel_04.png")
		3: # eyes
			random = randi_range(0,1)
			eyes.visible = false
			match random:
				0:
					...
					id_photo = load("res://Assets/Graphics/Char_Yog_Small_Photo_doppel_02.png")
					entry_photo = load("res://Assets/Graphics/Char_Yog_Long_Photo_doppel_02.png")
				_:
					eyes_doppel_02.visible = true
					id_photo = load("res://Assets/Graphics/Char_Yog_Small_Photo_doppel_03.png")
					entry_photo = load("res://Assets/Graphics/Char_Yog_Long_Photo_doppel_03.png")
		4: # Eyebrows
			eyebrows.visible = false
			eyebrows_doppel.visible = true
			id_photo = load("res://Assets/Graphics/Char_Yog_Small_Photo_doppel_01.png")
			entry_photo = load("res://Assets/Graphics/Char_Yog_Long_Photo_doppel_01.png")
		5: # scar
			scar.visible = true
			id_photo = load("res://Assets/Graphics/Char_Yog_Small_Photo_doppel_06.png")
			entry_photo = load("res://Assets/Graphics/Char_Yog_Long_Photo_doppel_06.png")
		_: # DDD logo
