...
@onready var nose_doppel_03 = $Head / Nose_doppel_03
@onready var mole = $Head / Mole
@onready var mole_2 = $Head / Mole2
@onready var mole_3 = $Head / Mole3
@onready var scar = $Head / Scar
@onready var scar_2 = $Head / Scar2
@onready var pimples = $Head / Pimples
...
func Ishtar()->void :
	id_photo = load("res://Assets/Graphics/Char_Ishtar_Small_Photo.png")
	entry_photo = load("res://Assets/Graphics/Char_Ishtar_Long_Photo.png")
	name_char = "Ishtar"
	last_name_char = "Ereskigal"
	number_id = "945269858896"
	id_exp_date = "04/1966"
	if Global.language == SPANISH_VALUE:
		apart_number = "P03-02"
		if randi_range(0, 1) == 0:
			entry_request_reason = "Soy residente de este círculo astral, salí a provocar plagas."
		else :
			entry_request_reason = "Soy residente de este círculo astral, mi apartamento es el 02 del tercer piso."
		...
		if randi_range(0, 1) == 0:
			not_today_list_text = ["No estoy en la lista porque tuve que hacer una plaga de emergencia."]
		else :
		...
		apart_number = "F03-02"
		if randi_range(0, 1) == 0:
			entry_request_reason = "I am a resident of this astral circle, I went out to cause pests."
		else :
			entry_request_reason = "I am a resident of this astral circle, my apartment is 02 on the third floor."
		...
		if randi_range(0, 1) == 0:
			not_today_list_text = ["I am not on the list because I had to provoke an emergency pest."]
		else :
		...
		apart_number = "F03-02"
		if randi_range(0, 1) == 0:
			entry_request_reason = "我是这个星界圈的居民，我出来引发瘟疫。"
		else :
			entry_request_reason = "我是这个星界圈的居民，我的公寓在三楼的02号。"
		hello_text = ["问候，人类。"]
		id_text = ["我的身份证是正确的。"]
		...
		if randi_range(0, 1) == 0:
			not_today_list_text = ["我不在名单上，因为我不得不引发一个紧急瘟疫。"]
		else :
		...
		0:
			...
			match random:
				0:
					name_char = "Isthar"
				1:
					last_name_char = "Ereskijal"
				2:
					name_char = "Ishtor"
				_:
					last_name_char = "Eneskigal"
		1:
			random = randi_range(0, 3)
			match random:
				0:
					number_id = "945268958896"
				1:
					number_id = "945269858869"
				2:
					number_id = "945296858896"
				_:
					number_id = "945269885896"
		2:
			nose.visible = false
			...
			match random:
				0:
					...
					id_photo = load("res://Assets/Graphics/Char_Ishtar_Small_Photo_doppel_01.png")
					entry_photo = load("res://Assets/Graphics/Char_Ishtar_Long_Photo_doppel_01.png")
				1:
					nose_doppel_02.visible = true
					id_photo = load("res://Assets/Graphics/Char_Ishtar_Small_Photo_doppel_02.png")
					entry_photo = load("res://Assets/Graphics/Char_Ishtar_Long_Photo_doppel_02.png")
				_:
					nose_doppel_03.visible = true
					id_photo = load("res://Assets/Graphics/Char_Ishtar_Small_Photo_doppel_03.png")
					entry_photo = load("res://Assets/Graphics/Char_Ishtar_Long_Photo_doppel_03.png")
		3:
			random = randi_range(0, 2)
			match random:
				0:
	...
	if Global.is_3312_active:
		...
		if is_doppelganger:
			...
			match doppel_number:
				...
				5:
					if Global.language == SPANISH_VALUE:
						Global.doppels_info += "Granos"
					elif Global.language == ENGLISH_VALUE:
						Global.doppels_info += "Pimples"
					elif Global.language == CHINESE_VALUE:
						Global.doppels_info += "痘痘"
				_:
					if Global.language == SPANISH_VALUE:
