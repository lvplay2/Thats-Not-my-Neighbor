...
@onready var tattoo_doppel_01 = $Head/Tattoo_doppel_01
@onready var tattoo_doppel_02 = $Head/Tattoo_doppel_02
...
func Teutates() -> void:
	id_photo = load("res://Assets/Graphics/Char_Teutates_Small_Photo.png")
	entry_photo = load("res://Assets/Graphics/Char_Teutates_Long_Photo.png")
	name_char = "Teutates"
	last_name_char = "Taranis"
	number_id = "789586413294"
	id_exp_date = "06/1963"
	if Global.language == SPANISH_VALUE:
		apart_number = "P03-03"
		if randi_range(0,1) == 0:
			entry_request_reason = "Soy residente de este círculo astral, salí a aniquilar cosas."
		else:
		...
		if randi_range(0,1) == 0:
			not_today_list_text = ["No estoy en la lista porque tuve que hacer una aniquilación de emergencia."]
		else:
		...
		apart_number = "F03-03"
		if randi_range(0,1) == 0:
			entry_request_reason = "I am a resident of this astral circle, I went out to annihilate things."
		else:
		...
		if randi_range(0,1) == 0:
			not_today_list_text = ["I am not on the list because I had to carry out an emergency annihilation."]
		else:
		...
		apart_number = "F03-03"
		if randi_range(0,1) == 0:
			entry_request_reason = "我是这个星界圈的居民，我出去毁灭东西。"
		else:
		...
		if randi_range(0,1) == 0:
			not_today_list_text = ["我不在名单上，因为我不得不进行紧急消灭。"]
		else:
		...
		0: #Name/Lastname
			...
			match random:
				0:
					name_char = "Teutattes"
				1:
					last_name_char = "Taronis"
				2:
					name_char = "Tevtates"
				_:
					last_name_char = "Taramis"
		1: #ID
			random = randi_range(0,3)
			match random:
				0:
					number_id = "789584613294"
				1:
					number_id = "785986413294"
				2:
					number_id = "789568413294"
				_:
					number_id = "789586412394"
		2: # tattoo
			...
			match random:
				0:
					...
					id_photo = load("res://Assets/Graphics/Char_Teutates_Small_Photo_doppel_01.png")
					entry_photo = load("res://Assets/Graphics/Char_Teutates_Long_Photo_doppel_01.png")
				_:
					tattoo_doppel_02.visible = true
					id_photo = load("res://Assets/Graphics/Char_Teutates_Small_Photo_doppel_02.png")
					entry_photo = load("res://Assets/Graphics/Char_Teutates_Long_Photo_doppel_02.png")
		3: # Nose
			nose.visible = false
			random = randi_range(0,1)
			match random:
				0:
					...
					id_photo = load("res://Assets/Graphics/Char_Teutates_Small_Photo_doppel_03.png")
					entry_photo = load("res://Assets/Graphics/Char_Teutates_Long_Photo_doppel_03.png")
				_:
					nose_doppel_02.visible = true
					id_photo = load("res://Assets/Graphics/Char_Teutates_Small_Photo_doppel_04.png")
					entry_photo = load("res://Assets/Graphics/Char_Teutates_Long_Photo_doppel_04.png")
		4: # Eyes
			eyes.visible = false
			eyes_doppel.visible = true
			id_photo = load("res://Assets/Graphics/Char_Teutates_Small_Photo_doppel_05.png")
			entry_photo = load("res://Assets/Graphics/Char_Teutates_Long_Photo_doppel_05.png")
		5: # Teeth
			pass
		_: # DDD logo
