...
const MIN_NUMBER_DOPPEL_CHAR = 4
const MAX_NUMBER_DOPPEL_CHAR = 6
...
const URL = "https://sites.google.com/view/dddsecrets"
const URL_ESP = "https://sites.google.com/view/dddsecretos"
