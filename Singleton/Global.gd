...
var is_id_wrong_answer = false
var is_appearance_wrong_answer = false
var is_entry_request_wrong_answer = false
var is_today_list_wrong_answer = false
...
var achievements_3 = {"7_DAYS": 0, "15_DAYS": 0, "FINAL_1": 0, "FINAL_2": 0, "FINAL_3": 0, "FINAL_4": 0, "FINAL_5": 0}
...
var record_day_count = 0
var current_campaign_day = 0
var neighbors_killed_list_1F = 10000000
var neighbors_killed_list_2F = 1000000
var neighbors_killed_list_3F = 10000000
var neighbors_killed_level_list_1F = 10000000
var neighbors_killed_level_list_2F = 1000000
var neighbors_killed_level_list_3F = 10000000
var is_endless = false
var neighbors_alive_list = []
var is_campaign = false
var red_handed = false
var just_complete_level = false
var neighbors_kill_count = 0
var neighbors_kill_count_aux = 0
var total_doppels_captured = 0
var total_doppels_got_in = 0
...
func reset_values()->void :
	...
	is_id_wrong_answer = false
	is_appearance_wrong_answer = false
	is_entry_request_wrong_answer = false
	is_today_list_wrong_answer = false
	...
	entity_spawn = false
	is_nightmare = false
	neighbors_killed_level_list_1F = 10000000
	neighbors_killed_level_list_2F = 1000000
	neighbors_killed_level_list_3F = 10000000
	is_endless = false
	is_campaign = false
	red_handed = false
	neighbors_kill_count_aux = 0
...
func load_record()->void :
	...
	if FileAccess.file_exists(SAVE_RECORD_02_PATH):
		...
		secret = false
		evil_badge = false
	if FileAccess.file_exists(SAVE_RECORD_03_PATH):
		var file3 = FileAccess.open(SAVE_RECORD_03_PATH, FileAccess.READ)
		current_day_count = file3.get_var(current_day_count)
		record_day_count = file3.get_var(record_day_count)
		current_campaign_day = file3.get_var(current_campaign_day)
		neighbors_killed_list_1F = file3.get_var(neighbors_killed_list_1F)
		neighbors_killed_list_2F = file3.get_var(neighbors_killed_list_2F)
		neighbors_killed_list_3F = file3.get_var(neighbors_killed_list_3F)
		neighbors_kill_count = file3.get_var(neighbors_kill_count)
		total_doppels_captured = file3.get_var(total_doppels_captured)
		total_doppels_got_in = file3.get_var(total_doppels_got_in)
	else :
		current_day_count = 0
		record_day_count = 0
		current_campaign_day = 0
		neighbors_killed_list_1F = 10000000
		neighbors_killed_list_2F = 1000000
		neighbors_killed_list_3F = 10000000
		neighbors_kill_count = 0
		total_doppels_captured = 0
		total_doppels_got_in = 0
...
func load_achievements()->void :
	...
	if FileAccess.file_exists(SAVE_ACHIEVEMENTS_03_PATH):
		var file3 = FileAccess.open(SAVE_ACHIEVEMENTS_03_PATH, FileAccess.READ)
		achievements_3["7_DAYS"] = file3.get_var(achievements_3["7_DAYS"])
		achievements_3["15_DAYS"] = file3.get_var(achievements_3["15_DAYS"])
		achievements_3["FINAL_1"] = file3.get_var(achievements_3["FINAL_1"])
		achievements_3["FINAL_2"] = file3.get_var(achievements_3["FINAL_2"])
		achievements_3["FINAL_3"] = file3.get_var(achievements_3["FINAL_3"])
		achievements_3["FINAL_4"] = file3.get_var(achievements_3["FINAL_4"])
		achievements_3["FINAL_5"] = file3.get_var(achievements_3["FINAL_5"])
	else :
		achievements_3 = {"7_DAYS": 0, "15_DAYS": 0, "FINAL_1": 0, "FINAL_2": 0, "FINAL_3": 0, "FINAL_4": 0, "FINAL_5": 0}
...
func save_record()->void :
	...
	var file3 = FileAccess.open(SAVE_RECORD_03_PATH, FileAccess.WRITE)
	file3.store_var(current_day_count)
	file3.store_var(record_day_count)
	file3.store_var(current_campaign_day)
	file3.store_var(neighbors_killed_list_1F)
	file3.store_var(neighbors_killed_list_2F)
	file3.store_var(neighbors_killed_list_3F)
	file3.store_var(neighbors_kill_count)
	file3.store_var(total_doppels_captured)
	file3.store_var(total_doppels_got_in)
...
func save_achievements()->void :
	...
	var file3 = FileAccess.open(SAVE_ACHIEVEMENTS_03_PATH, FileAccess.WRITE)
	file3.store_var(achievements_3["7_DAYS"])
	file3.store_var(achievements_3["15_DAYS"])
	file3.store_var(achievements_3["FINAL_1"])
	file3.store_var(achievements_3["FINAL_2"])
	file3.store_var(achievements_3["FINAL_3"])
	file3.store_var(achievements_3["FINAL_4"])
	file3.store_var(achievements_3["FINAL_5"])

func update_neighbors_alive()->void :
	var digit: int = 0
	var neighbors_killed_1F = neighbors_killed_list_1F
	var neighbors_killed_2F = neighbors_killed_list_2F
	var neighbors_killed_3F = neighbors_killed_list_3F
	var current_neighbor
	var current_neighbor_name
	neighbors_alive_list = []
	while digit < 7:
		current_neighbor = neighbors_killed_1F % 10
		neighbors_killed_1F = int(neighbors_killed_1F / 10)
		var indice = 0
		match digit:
			0:
				indice = 5
			...
			6:
				indice = 0
		current_neighbor_name = CHAR_LIST[indice]
		if current_neighbor == 0:
			neighbors_alive_list.append(current_neighbor_name)
		digit += 1
	digit = 0
	while digit < 6:
		current_neighbor = neighbors_killed_2F % 10
		neighbors_killed_2F = int(neighbors_killed_2F / 10)
		var indice = 0
		match digit:
			0:
				indice = 16
	...
	digit = 0
	while digit < 7:
		current_neighbor = neighbors_killed_3F % 10
		neighbors_killed_3F = int(neighbors_killed_3F / 10)
		var indice = 0
		match digit:
			0:
				indice = 7
...
func update_neighbors_dead()->Array:
	var digit: int = 0
	var neighbors_killed_1F = neighbors_killed_level_list_1F
	var neighbors_killed_2F = neighbors_killed_level_list_2F
	var neighbors_killed_3F = neighbors_killed_level_list_3F
	var current_neighbor
	var current_neighbor_name
	var result = []
	neighbors_alive_list = []
	while digit < 7:
		...
		if current_neighbor == 1:
			result.append(current_neighbor_name)
		digit += 1
	digit = 0
	while digit < 6:
		current_neighbor = neighbors_killed_2F % 10
